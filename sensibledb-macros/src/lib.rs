        ...
        static #static_name: () = {
            inventory::submit! {
                ::sensibledb_db::sensibledb_gateway::router::router::HandlerSubmission(
                    ::sensibledb_db::sensibledb_gateway::router::router::Handler::new(
                        #fn_name_str,
                        #fn_name,
                        #is_write
                    )
...
pub fn migration(args: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        static #static_name: () = {
            inventory::submit! {
                ::sensibledb_db::sensibledb_engine::graph_core::ops::version_info::TransitionSubmission(
                    ::sensibledb_db::sensibledb_engine::graph_core::ops::version_info::Transition::new(
                        stringify!(#item),
                        #from_version,
                        #to_version,
                        #fn_name
