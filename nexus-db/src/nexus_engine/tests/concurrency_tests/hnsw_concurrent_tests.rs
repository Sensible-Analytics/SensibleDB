...
use crate::nexus_engine::storage_core::NexusGraphStorage;
use crate::nexus_engine::storage_core::version_info::VersionInfo;
use crate::nexus_engine::traversal_core::config::Config;
use crate::nexus_engine::traversal_core::ops::g::G;
use crate::nexus_engine::traversal_core::ops::vectors::insert::InsertVAdapter;
use crate::nexus_engine::traversal_core::ops::vectors::search::SearchVAdapter;
use crate::nexus_engine::vector_core::vector::HVector;
                    ...
                    .collect::<Result<Vec<_>, _>>()
                {
                    Ok(results) => {
                        ...
                        for (i, result) in results.iter().enumerate() {
                            if let crate::nexus_engine::traversal_core::traversal_value::TraversalValue::Vector(v) = result {
                                assert!(
                                    v.distance.is_some(),
