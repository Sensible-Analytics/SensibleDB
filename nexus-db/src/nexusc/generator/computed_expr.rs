...
use crate::nexusc::parser::types::{Expression, ExpressionType, MathFunction};
...
fn generate_traversal_value(
    traversal: &crate::nexusc::parser::types::Traversal,
    item_var: &str,
) -> String {
    use crate::nexusc::parser::types::{GraphStepType, StartNode, StepType};
