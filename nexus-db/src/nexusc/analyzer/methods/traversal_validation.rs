use crate::nexusc::analyzer::error_codes::*;
use crate::nexusc::analyzer::utils::{
    DEFAULT_VAR_NAME, VariableInfo, check_identifier_is_fieldtype, validate_embed_string_type,
};
use crate::nexusc::generator::bool_ops::{Contains, IsIn, PropertyEq, PropertyNeq};
use crate::nexusc::generator::source_steps::{SearchVector, VFromID, VFromType};
use crate::nexusc::generator::traversal_steps::{AggregateBy, GroupBy};
use crate::nexusc::generator::utils::{EmbedData, VecData};
use crate::{
    generate_error,
    nexusc::{
        analyzer::{
        ...
        match step {
                    ...
                    GeneratedStatement::Traversal(tr) => {
                        gen_traversal
                            ...
                            .push(Separator::Period(GeneratedStep::Intersect(
                                crate::nexusc::generator::traversal_steps::Intersect {
                                    traversal: tr,
                                },
                            )));
            ...
            StepType::RerankRRF(rerank_rrf) => {
                ...
                gen_traversal
                    ...
                    .push(Separator::Period(GeneratedStep::RerankRRF(
                        crate::nexusc::generator::traversal_steps::RerankRRF { k },
                    )));
            }
            StepType::RerankMMR(rerank_mmr) => {
                ...
                let distance = if let Some(MMRDistance::Identifier(id)) = &rerank_mmr.distance {
                    ...
                    Some(
                        crate::nexusc::generator::traversal_steps::MMRDistanceMethod::Identifier(
                            id.clone(),
                        ),
                    )
                } else {
                    rerank_mmr.distance.as_ref().map(|d| match d {
                        MMRDistance::Cosine => {
                            crate::nexusc::generator::traversal_steps::MMRDistanceMethod::Cosine
                        }
                        MMRDistance::Euclidean => {
                            crate::nexusc::generator::traversal_steps::MMRDistanceMethod::Euclidean
                        }
                        MMRDistance::DotProduct => {
                            crate::nexusc::generator::traversal_steps::MMRDistanceMethod::DotProduct
                        }
                ...
                gen_traversal
                    ...
                    .push(Separator::Period(GeneratedStep::RerankMMR(
                        crate::nexusc::generator::traversal_steps::RerankMMR { lambda, distance },
                    )));
            }
        }
...
#[cfg(test)]
mod tests {
    use crate::nexusc::analyzer::error_codes::ErrorCode;
    use crate::nexusc::generator::statements::Statement as GeneratedStatement;
    use crate::nexusc::generator::traversal_steps::TraversalType;
    use crate::nexusc::parser::{NexusParser, write_to_temp_file};
    ...
    fn test_undeclared_node_type() {
        ...
        let result = crate::nexusc::analyzer::analyze(&parsed);
