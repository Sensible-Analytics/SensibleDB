...
use crate::nexusc::analyzer::utils::{VariableInfo, type_in_scope, validate_embed_string_type};
use crate::nexusc::generator::traversal_steps::EdgeType;
use crate::nexusc::generator::utils::EmbedData;
use crate::{
    generate_error,
    nexusc::{
        analyzer::{
                    ...
                    if let Some(edge_fields) = ctx.edge_fields.get(edge_type.as_str()) {
                        if let Some(field) = edge_fields.get(weight_prop.as_str()) {
                            ...
                            match &field.field_type {
                                crate::nexusc::parser::types::FieldType::F32
                                | crate::nexusc::parser::types::FieldType::F64
                                | crate::nexusc::parser::types::FieldType::I8
                                | crate::nexusc::parser::types::FieldType::I16
                                | crate::nexusc::parser::types::FieldType::I32
                                | crate::nexusc::parser::types::FieldType::I64
                                | crate::nexusc::parser::types::FieldType::U8
                                | crate::nexusc::parser::types::FieldType::U16
                                | crate::nexusc::parser::types::FieldType::U32
                                | crate::nexusc::parser::types::FieldType::U64
                                | crate::nexusc::parser::types::FieldType::U128 => {
