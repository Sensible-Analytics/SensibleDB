...
Command-line interface for managing SensibleDB projects and deployments.
...
- `dashboard`: manage the SensibleDB Dashboard.
- `update`: update the CLI.
- `migrate`: migrate v1 projects to v2.
- `backup`: back up an instance.
- `feedback`: send feedback to the SensibleDB team.

Run `sensibledb <command> --help` for command-specific flags and options.
