...
- CLI: `~/GitHub/sensibledb-db/sensibledb-cli`
...
- [x] Confirm API key is present in `~/.sensibledb/credentials`
...
- [x] `nexus sync <enterprise-instance>` successfully refreshes `sensibledb.toml` project/cluster metadata
