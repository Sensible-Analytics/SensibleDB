...
const GITHUB_API_URL: &str = "https://api.github.com/repos/Sensible-Analytics/SensibleDB/releases/latest";
...
fn get_update_cache_path() -> Result<PathBuf> {
    ...
    Ok(sensibledb_dir.join("update_cache.toml"))
}

async fn fetch_latest_version() -> Result<String> {
    let client = Client::builder()
        .user_agent(format!("sensibledb-cli/{CURRENT_VERSION}"))
