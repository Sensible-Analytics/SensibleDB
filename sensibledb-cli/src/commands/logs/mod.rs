//! `nexus logs` command for viewing instance logs.
//!
//! Supports two modes:
...
pub async fn run(
    ...
    let instance_name = match instance {
        ...
        None if prompts::is_interactive() => {
            ...
            prompts::intro("nexus logs", Some("View logs for your instance\n"))?;
    ...
    let credentials = if let InstanceInfo::Nexus(_) = &instance_config {
