...
impl LogSource {
    ...
    pub fn from_instance(
        ...
        if instance_config.is_local() {
            ...
            let project_name = format!("nexus-{}-{}", project.config.project.name, instance_name);
            ...
            Ok(LogSource::Cloud {
                ...
                api_key: credentials.nexus_admin_key.clone(),
            })
        }
    }
...
/// Stream live logs from SensibleDB Cloud via SSE.
...
/// Query historical logs from SensibleDB Cloud.
