...
async fn check_instance(
    ...
    repo_step.start();
    build::ensure_sensibledb_repo_cached().await?;
    repo_step.done();
    ...
    let generated_src = instance_workspace.join("nexus-container/src");
    let cargo_check_src = instance_workspace.join("nexus-repo-copy/nexus-container/src");
    ...
    let sensibledb_container_dir = instance_workspace.join("nexus-repo-copy/nexus-container");
