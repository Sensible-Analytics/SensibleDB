...
pub enum DashboardAction {
    ...
    Start {
        ...
        /// Nexus host to connect to (e.g., localhost). Bypasses project config.
        #[arg(long)]
        host: Option<String>,

        /// Nexus port to connect to. Used with --host.
...
pub enum CloudDeploymentTypeCommand {
    ...
    #[command(name = "cloud")]
    Nexus {
        /// Region for Nexus cloud instance (default: us-east-1)
