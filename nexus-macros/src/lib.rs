        ...
        static #static_name: () = {
            inventory::submit! {
                ::nexus_db::nexus_gateway::router::router::HandlerSubmission(
                    ::nexus_db::nexus_gateway::router::router::Handler::new(
                        #fn_name_str,
                        #fn_name,
                        #is_write
                    )
...
pub fn migration(args: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        static #static_name: () = {
            inventory::submit! {
                ::nexus_db::nexus_engine::graph_core::ops::version_info::TransitionSubmission(
                    ::nexus_db::nexus_engine::graph_core::ops::version_info::Transition::new(
                        stringify!(#item),
                        #from_version,
                        #to_version,
                        #fn_name
