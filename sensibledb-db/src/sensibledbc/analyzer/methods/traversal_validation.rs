use crate::sensibledbc::analyzer::error_codes::*;
use crate::sensibledbc::analyzer::utils::{
    DEFAULT_VAR_NAME, VariableInfo, check_identifier_is_fieldtype, validate_embed_string_type,
};
use crate::sensibledbc::generator::bool_ops::{Contains, IsIn, PropertyEq, PropertyNeq};
use crate::sensibledbc::generator::source_steps::{SearchVector, VFromID, VFromType};
use crate::sensibledbc::generator::traversal_steps::{AggregateBy, GroupBy};
use crate::sensibledbc::generator::utils::{EmbedData, VecData};
use crate::{
    generate_error,
    sensibledbc::{
        analyzer::{
        ...
        match step {
                    ...
                    GeneratedStatement::Traversal(tr) => {
                        gen_traversal
                            ...
                            .push(Separator::Period(GeneratedStep::Intersect(
                                crate::sensibledbc::generator::traversal_steps::Intersect {
                                    traversal: tr,
                                },
                            )));
            ...
            StepType::RerankRRF(rerank_rrf) => {
                ...
                gen_traversal
                    ...
                    .push(Separator::Period(GeneratedStep::RerankRRF(
                        crate::sensibledbc::generator::traversal_steps::RerankRRF { k },
                    )));
            }
            StepType::RerankMMR(rerank_mmr) => {
                ...
                let distance = if let Some(MMRDistance::Identifier(id)) = &rerank_mmr.distance {
                    ...
                    Some(
                        crate::sensibledbc::generator::traversal_steps::MMRDistanceMethod::Identifier(
                            id.clone(),
                        ),
                    )
                } else {
                    rerank_mmr.distance.as_ref().map(|d| match d {
                        MMRDistance::Cosine => {
                            crate::sensibledbc::generator::traversal_steps::MMRDistanceMethod::Cosine
                        }
                        MMRDistance::Euclidean => {
                            crate::sensibledbc::generator::traversal_steps::MMRDistanceMethod::Euclidean
                        }
                        MMRDistance::DotProduct => {
                            crate::sensibledbc::generator::traversal_steps::MMRDistanceMethod::DotProduct
                        }
                ...
                gen_traversal
                    ...
                    .push(Separator::Period(GeneratedStep::RerankMMR(
                        crate::sensibledbc::generator::traversal_steps::RerankMMR { lambda, distance },
                    )));
            }
        }
...
#[cfg(test)]
mod tests {
    use crate::sensibledbc::analyzer::error_codes::ErrorCode;
    use crate::sensibledbc::generator::statements::Statement as GeneratedStatement;
    use crate::sensibledbc::generator::traversal_steps::TraversalType;
    use crate::sensibledbc::parser::{NexusParser, write_to_temp_file};
    ...
    fn test_undeclared_node_type() {
        ...
        let parsed = NexusParser::parse_source(&content).unwrap();
        let result = crate::sensibledbc::analyzer::analyze(&parsed);
