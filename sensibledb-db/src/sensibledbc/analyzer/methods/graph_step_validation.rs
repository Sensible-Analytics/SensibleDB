...
use crate::sensibledbc::analyzer::utils::{VariableInfo, type_in_scope, validate_embed_string_type};
use crate::sensibledbc::generator::traversal_steps::EdgeType;
use crate::sensibledbc::generator::utils::EmbedData;
use crate::{
    generate_error,
    sensibledbc::{
        analyzer::{
                    ...
                    if let Some(edge_fields) = ctx.edge_fields.get(edge_type.as_str()) {
                        if let Some(field) = edge_fields.get(weight_prop.as_str()) {
                            ...
                            match &field.field_type {
                                crate::sensibledbc::parser::types::FieldType::F32
                                | crate::sensibledbc::parser::types::FieldType::F64
                                | crate::sensibledbc::parser::types::FieldType::I8
                                | crate::sensibledbc::parser::types::FieldType::I16
                                | crate::sensibledbc::parser::types::FieldType::I32
                                | crate::sensibledbc::parser::types::FieldType::I64
                                | crate::sensibledbc::parser::types::FieldType::U8
                                | crate::sensibledbc::parser::types::FieldType::U16
                                | crate::sensibledbc::parser::types::FieldType::U32
                                | crate::sensibledbc::parser::types::FieldType::U64
                                | crate::sensibledbc::parser::types::FieldType::U128 => {
