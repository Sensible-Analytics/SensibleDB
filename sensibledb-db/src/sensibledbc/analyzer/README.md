...
## Overview
The analyzer module performs static analysis and type checking on the NQL AST, ensuring queries are grammatically and semantically correct before code generation.
