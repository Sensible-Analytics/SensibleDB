...
use crate::sensibledbc::parser::types::{Expression, ExpressionType, MathFunction};
...
fn generate_traversal_value(
    traversal: &crate::sensibledbc::parser::types::Traversal,
    item_var: &str,
) -> String {
    use crate::sensibledbc::parser::types::{GraphStepType, StartNode, StepType};
