use crate::sensibledbc::parser::{
    NexusParser, ParserError, Rule,
    location::HasLoc,
...
mod tests {
    ...
    fn test_parse_simple_query() {
        ...
        let result = NexusParser::parse_source(&content);
        assert!(result.is_ok());
    ...
    fn test_parse_query_with_array_parameter() {
        ...
        assert!(matches!(
            ...
            crate::sensibledbc::parser::types::FieldType::Array(_)
        ));
    }
    ...
    fn test_parse_query_with_object_parameter() {
        ...
        assert!(matches!(
            parsed.queries[0].parameters[0].param_type.1,
            crate::sensibledbc::parser::types::FieldType::Object(_)
        ));
    }
}
