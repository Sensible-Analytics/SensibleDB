...
use crate::sensibledb_engine::storage_core::graph_visualization::GraphVisualization;
use crate::sensibledb_engine::types::GraphError;
use crate::sensibledb_gateway::gateway::AppState;
use crate::sensibledb_gateway::router::router::{Handler, HandlerInput, HandlerSubmission};
...
fn get_all_nodes_edges_json(
    db: &Arc<crate::sensibledb_engine::storage_core::SensibleGraphStorage>,
    txn: &RoTxn,
    node_label: Option<String>,
    arena: &bumpalo::Bump,
