...
**Query-Based Access Control**: SensibleDB is private by default - you can only access your data through compiled NQL queries.
...
**Compile-Time Query Validation**: NQL is 100% type-safe, which lets you develop and deploy with confidence that your queries will execute in production.
